...
/**
 * Provides application-wide mode (personal/umkm), theme (light/dark),
 * and notification preferences with localStorage persistence.
 */
...
/** @throws {Error} When used outside of ModeProvider. */
