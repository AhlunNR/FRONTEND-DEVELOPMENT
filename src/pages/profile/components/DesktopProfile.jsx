    ...
    <div className="w-full max-w-7xl mx-auto px-8 py-10 space-y-8 animate-in fade-in zoom-in-95 duration-500 bg-background text-foreground transition-colors" id="snap-main-container">
      <AnimatedContent distance={30} delay={0.1} direction="vertical">
        <header>
          ...
          <p className="text-sm text-muted-foreground mt-1 text-balance">Kelola preferensi akun dan personalisasi aplikasi KasFlow Anda.</p>
        </header>
      </AnimatedContent>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        {/* Kolom Kiri: Info User & Stats */}
        <AnimatedContent distance={40} delay={0.2} direction="horizontal" className="lg:col-span-4 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <Card className="border-border bg-card shadow-sm overflow-hidden text-center py-4 hover:bg-accent/50 transition-colors cursor-default">
              <div className="flex flex-col items-center gap-2">
                <div className="p-2.5 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full">
                  <WalletCards className="w-6 h-6" />
                </div>
                <p className="text-2xl font-black text-foreground">124</p>
                <p className="text-[10px] sm:text-xs font-bold text-muted-foreground uppercase tracking-wide">Transaksi</p>
              </div>
            </Card>
            <Card className="border-border bg-card shadow-sm overflow-hidden text-center py-4 hover:bg-accent/50 transition-colors cursor-default">
              <div className="flex flex-col items-center gap-2">
                <div className="p-2.5 bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 rounded-full">
                  <Medal className="w-6 h-6" />
                </div>
                <p className="text-2xl font-black text-foreground">12</p>
                <p className="text-[10px] sm:text-xs font-bold text-muted-foreground uppercase tracking-wide">Badges</p>
              </div>
            </Card>
            <Card className="border-border bg-card shadow-sm overflow-hidden text-center py-4 hover:bg-accent/50 transition-colors cursor-default">
              <div className="flex flex-col items-center gap-2">
                <div className="p-2.5 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 rounded-full">
                  <Flame className="w-6 h-6" />
                </div>
                <p className="text-2xl font-black text-foreground">5</p>
                <p className="text-[10px] sm:text-xs font-bold text-muted-foreground uppercase tracking-wide">Day Streak</p>
              </div>
            </Card>
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground">KasFlow v1.0.0</p>
        </AnimatedContent>
        ...
        <AnimatedContent distance={40} delay={0.3} direction="vertical" className="lg:col-span-8 space-y-6">
          ...
          <Card className="border-border bg-card shadow-sm overflow-hidden">
            <CardHeader className="bg-muted/30 border-b border-border py-4 px-6 relative overflow-hidden">
              ...
              <CardTitle className="text-sm font-bold uppercase tracking-wider text-muted-foreground">Preferensi Aplikasi</CardTitle>
            </CardHeader>
            <div className="flex flex-col divide-y divide-border">
              <button onClick={toggleMode} className="flex items-center justify-between p-6 hover:bg-accent transition text-left group">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <p className="text-lg font-bold text-foreground">Mode Aplikasi</p>
                    <p className="text-sm text-muted-foreground mt-1">{isPersonal ? "Mengelola keuangan pribadi" : "Mengelola keuangan UMKM"}</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <span className={`text-sm font-bold px-4 py-1.5 rounded-full ${themeBg} ${themeColor}`}>{isPersonal ? "Personal" : "UMKM"}</span>
              ...
              <button onClick={toggleTheme} className="flex items-center justify-between p-6 hover:bg-accent transition text-left group">
                <div className="flex items-center gap-5">
                  <div className="p-4 rounded-xl bg-muted text-foreground group-hover:scale-110 transition-transform">
                    {isDark ? <Sun className="w-6 h-6" /> : <Moon className="w-6 h-6" />}
                  </div>
                  <div>
                    <p className="text-lg font-bold text-foreground">Tema Tampilan</p>
                    <p className="text-sm text-muted-foreground mt-1">{isDark ? "Mode Gelap (Dark Mode)" : "Mode Terang (Light Mode)"}</p>
                  </div>
                </div>
              ...
              <button onClick={toggleNotifications} className="flex items-center justify-between p-6 hover:bg-accent transition text-left group">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <p className="text-lg font-bold text-foreground">Notifikasi</p>
                    <p className="text-sm text-muted-foreground mt-1">{notifications ? "Peringatan aktif" : "Peringatan dibisukan"}</p>
                  </div>
                </div>
              ...
              <Link to="/gamification" className="flex items-center justify-between p-6 hover:bg-accent transition block w-full group">
                <div className="flex items-center gap-5">
                  ...
                  <div className="text-left">
                    <p className="text-lg font-bold text-foreground">Pencapaian (Achievements)</p>
                    <p className="text-sm text-muted-foreground mt-1">Lihat Level Finansial & Koleksi Badges Anda</p>
                  </div>
                </div>
                <ChevronRight className="w-6 h-6 text-muted-foreground group-hover:text-foreground transition-colors" />
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="border-border bg-card shadow-sm overflow-hidden flex flex-col h-full">
              ...
              <div className="flex flex-col divide-y divide-border text-foreground flex-1">
                ...
                <button className="flex items-center justify-between p-6 hover:bg-accent transition text-left group flex-1">
                  <div className="flex items-center gap-4">
                    ...
                    <p className="text-base font-bold">Pengaturan Privasi</p>
                  </div>
                  <ChevronRight className="w-5 h-5 text-muted-foreground group-hover:text-foreground transition-colors" />
                </button>
              </div>
